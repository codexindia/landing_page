...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <div className="max-w-[85rem] mt-20 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid gap-4">
                  ...
                  <div>
                    ...
                    <textarea id="hs-about-contacts-1" onChange={(e) => setMessage(e.target.value)} name="hs-about-contacts-1" rows={4} className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-green-400 focus:ring-green-400 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Details"></textarea>
                  </div>
                </div>

                <ReCAPTCHA onChange={onChange} className='mt-5' style={{ transform: "scale(0.85)", transformOrigin: "0 0" }}
                  sitekey="6LebaC8bAAAAAK1Ma0X3SHUSv5feLpEytTFTC7Yk"
