...
export default function Testimonials() {
    return (
        <> 
        <div className="p-0 m-0 group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
          
            <div className="">
            <div className="overflow-hidden" >
                <div className="relative max-w-[85rem] px-4  sm:px-6 lg:px-8 pb-20 mx-auto">

                    <div className="text-center  mb-6 pt-7 sm:mb-10 md:mb-16">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="flex h-auto">
                            <div className="flex flex-col bg-gray-100 rounded-xl dark:bg-slate-900">
                                ...
                                <div className="p-4 bg-indigo rounded-b-xl md:px-7 dark:bg-slate-700">
